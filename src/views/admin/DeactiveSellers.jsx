                        ...
                        <table className='w-full text-sm text-left text-white'>
                            <thead className='text-xs text-white uppercase border-b border-slate-700'>
                                <tr>
                                    ...
                                    <th className='py-3 px-4 whitespace-nowrap' scope='col'>  status    </th>
                                    ...
                                    [1, 2, 3, 4, 5].map((d, i) => <tr key={i}>
                                        ...
                                        <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                            <div className='w-[45px] h-[45px] rounded-md'>
                                                <img className='w-full' src="http://localhost:3000/images/admin.jpg" alt="" />
                                            </div>
                                        </td>
                                        <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                            <span>sk arman</span>
                                        ...
                                        <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                            <span>skarman@gmail.com</span>
                                        </td>
                                        <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                            <span>pending</span>
                                        </td>
                                        <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap '>
                                            <Link className='bg-green-200 ' ><BsEye className='text-green-500 text-lg' /></Link>
                                        </td>
                                    </tr>)
                                }
                            </tbody>
